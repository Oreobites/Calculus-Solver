...
public class Exponential_function {
	...
	public String calcExponential(String func) {
	...
	public String expo_1(String arr) { // +가 없는 n^x의 단순한 형태
	...
	public String expo_2(String arr) { // +가 1개 이상 있는 계산식
		String result = "";
		String multiple = "";
		String multiple2 = "";
		int a = 0, n_1 = 0, z_1 = 0, z_2 = 0, m = 0, s = 0, f = 0, p = 0; // n_1은
																			// ^의
																			// 개수
																			// 카운트,
																			// n_2은
		...
		for (int i = 0; i <= n_1; i++) {
			...
			if (a == 0) { // *없으면
				...
				z_1 = Integer.parseInt(multiple.replaceAll("\\D+", "")); // *앞에
																			// 있는
																			// 상수를
																			// Int형으로
																			// 바꿔서
