...
public class Trigonometric_function {
    ...
    public static String Differential(String func) { //미분한 함수를 String으로 반환
        String DResult;
    ...
    public static String Integral(String func) { //부정적분 (적분상수 빼고)
        String IResult;
        int pos = func.indexOf("*");
    ...
    public static double NDifferential(String func, double x) { //f(x)와 x가 주어지면 f'(x)를 반환
        double NDResult;
        int pos = func.indexOf("*");
        int Coefficient;
    ...
    public static double Staticfraction(String func, double x) { //정적분한 함수에 값을 대입한 것을 반환
        double NIResult;
        int pos = func.indexOf("*");
        int Coefficient;
        if(pos != -1) Coefficient = Integer.parseInt(func.substring(0, pos));
